...
{
    public class ReviewCIOrPassDialog : CancelDialog
    {
        ...
        public ReviewCIOrPassDialog(PrivateConversationState userState, ILuisService luisService)
            : base(nameof(ReviewCIOrPassDialog))
        {
        ...
        private async Task<DialogTurnResult> FinalProcess(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                return await stepContext.ReplaceDialogAsync(nameof(ReviewCIOrPassDialog), stepContext.Values, cancellationToken);
            }
        ...
        {
            var reply = MessageFactory.Text("Tu tipo de documento de identidad corresponde a Venezolano (V), Extranjero (E) o Pasaporte( P)");
