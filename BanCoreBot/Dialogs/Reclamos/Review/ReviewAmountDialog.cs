...
{
    public class ReviewAmountDialog : CancelDialog
    {
        ...
        public ReviewAmountDialog(PrivateConversationState userState)
            : base(nameof(ReviewAmountDialog))
        {
        ...
        private async Task<DialogTurnResult> FinalProcess(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                return await stepContext.ReplaceDialogAsync(nameof(ReviewAmountDialog), stepContext.Values, cancellationToken);
            }
        ...
        private async Task<Activity> CreateButtonsConfirm(WaterfallStepContext stepContext, string retry)
        {
            var userStateAccessors = _userState.CreateProperty<UserPersonalData>(nameof(UserPersonalData));
            ClientData = await userStateAccessors.GetAsync(stepContext.Context, () => new UserPersonalData());
            var reply = MessageFactory.Text($"¿Confirmas que el monto ingresado es correcto?" +
