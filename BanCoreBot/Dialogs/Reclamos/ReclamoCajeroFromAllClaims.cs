...
{
    public class ReclamoCajeroFromAllClaims : CancelDialog
    {
        ...
        public ReclamoCajeroFromAllClaims(ISendGridEmailService sendGridEmailService, PrivateConversationState userState)
            : base(nameof(ReclamoCajeroFromAllClaims))
        {
