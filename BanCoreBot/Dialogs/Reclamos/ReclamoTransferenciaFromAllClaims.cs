...
{
    public class ReclamoTransferenciaFromAllClaims : CancelDialog
    {
        ...
        public ReclamoTransferenciaFromAllClaims(ISendGridEmailService sendGridEmailService, PrivateConversationState userState)
            : base(nameof(ReclamoTransferenciaFromAllClaims))
        {
