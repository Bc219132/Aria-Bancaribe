...
{
    public class ReclamoMiPago : CancelDialog
    {
        ...
        public ReclamoMiPago(ISendGridEmailService sendGridEmailService, PrivateConversationState userState)
            : base(nameof(ReclamoMiPago))
        {
