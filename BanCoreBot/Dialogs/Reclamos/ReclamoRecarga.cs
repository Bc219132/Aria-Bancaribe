...
{
    public class ReclamoRecarga : CancelDialog
    {
        ...
        public ReclamoRecarga(ISendGridEmailService sendGridEmailService, PrivateConversationState userState)
            : base(nameof(ReclamoRecarga))
        {
        ...
        private Activity CreateButtonsClaims(string retry)
        {
            ...
            {
                reply = MessageFactory.Text("¿Desea crear un reclamo referente al servicio de recarga telefónica?");
            }
            else
            {
                reply = MessageFactory.Text("Por favor indique una respuesta, ¿Desea crear un reclamo referente al servicio de recarga telefónica?");
            }
