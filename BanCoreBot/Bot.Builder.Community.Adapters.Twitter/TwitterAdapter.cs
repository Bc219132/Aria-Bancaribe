...
namespace Bot.Builder.Community.Adapters.Twitter
{
    public class TwitterAdapter : BotAdapter
    {
        ...
        {
            /*
             * CAMBIOS REALIZADOS POR JZERPAE
             * 
             * Se añade el atributo Attachment para verificar si se cargo una imagen en twitter
             *            
             */
            if (obj.MessageEntities.media != null)
            {
                IList<Attachment> attachments = new List<Attachment>();
                Attachment attachment = new Attachment();
                attachment.ContentUrl = obj.MessageEntities.media[0].display_url;
            ...
            else // Lo que contiene se sección else es el código Original de la librería
            {
                return new Activity
                {
                    Text = obj.MessageText,
